...
// Fallback used when the `faqs` table is empty for page='services'
const FALLBACK_FAQS: Faq[] = [
  {
    id: "s1",
    question: "How do you manage remote teams and ensure seamless execution?",
    answer:
  ...
  {
    id: "s2",
    question: "Can we scale across different departments as our needs evolve?",
    answer:
  ...
  {
    id: "s3",
    question: "How are you able to offer 40-60% cost reductions in manufacturing and development?",
    answer:
  ...
  {
    id: "s4",
    question: "Does your team handle emerging technologies like AI and Web3?",
    answer:
  ...
  {
    id: "s5",
    question: "Why should a traditional brand consider your Esports solutions?",
    answer:
...
export default function FaqSection() {
  ...
  const { data: faqs } = useCMS<Faq>("faqs", {
    filter: { page: "services", is_active: true },
    orderBy: "sort_order",
