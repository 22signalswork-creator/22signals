...
// Fallback used when the `faqs` table is empty for page='portfolio'
const FALLBACK_FAQS: Faq[] = [
  {
    id: "p1",
    question: "Do you have experience working within my specific industry?",
    answer:
  ...
  {
    id: "p2",
    question: "Can I request a more detailed case study for a specific project?",
    answer:
  ...
  {
    id: "p3",
    question: "Were these projects executed using your dedicated supervisor model?",
    answer:
  ...
  {
    id: "p5",
    question: "How quickly can we start a project like the ones shown here?",
    answer:
...
export default function FaqSection() {
  ...
  const { data: faqs } = useCMS<Faq>("faqs", {
    filter: { page: "portfolio", is_active: true },
    orderBy: "sort_order",
